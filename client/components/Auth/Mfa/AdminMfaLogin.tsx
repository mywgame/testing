      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 text-center text-lg font-mono tracking-[0.3em] font-extrabold border-2 border-slate-300/80 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/70 backdrop-blur-sm text-slate-950 placeholder:text-slate-400 shadow-sm"
            required
            autoFocus
          />
        </div>
